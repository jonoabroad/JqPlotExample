...
(function($) {
    ...
    $.jqplot = function(target, data, options) {
        ...
        if ($.jqplot.config.catchErrors) {
            ...
            console.log("_data",_data,"_options",_options);
            plot.init(target, _data, _options);
            plot.draw();
            plot.themeEngine.init.call(plot);
            return plot;
    ...
    function jqPlot() {
        ...
        // series data.
        this._stackData = [];
        console.log("1720 this._stackData",this._stackData);
        ...
        this.init = function(target, data, options) {
            ...
            this._sumy = 0;
            this._sumx = 0;
            console.log("1924 this.series",this.series);
            for (var i=0; i<this.series.length; i++) {
                console.log("1926 this.series[i]",this.series[i]);
